                        ...
                        <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/cars/update">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="manufacturer" name="manufacturer" value="${constructeur}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" min="2" max ="9" class="form-control" id="seats" name="seats" value="${nb_places}">
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
